...
class StudentSearch extends Student
{
    ...
    */
    ...
    {
        return [
            [['ID', 'recruiter_id', 'country_of_citizenship', 'country', 'country_of_education', 'graduated_recent_school', 'exact_score_listening', 'exact_score_reading', 'exact_score_writing', 'exact_score_speaking', 'exact_score_overall', 'refused_visa', 'created_at', 'updated_at','status'], 'integer'],
