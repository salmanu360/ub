    ...
    */
    public function rules()
    {
        return [
            ...
            [['first_name', 'middle_name', 'last_name', 'birth_date', 'email_id', 'phone_no', 'gender', 'first_language', 'marital_status', 'lead_status', 'referral_source', 'passport_no', 'passport_expiry_date', 'address', 'city', 'state', 'zip_code', 'highest_level_education', 'grading_scheme', 'english_exam_type', 'date_of_exam', 'study_permit', 'details', 'upload_document','status','rm_id'], 'safe'],
        ];
    }
