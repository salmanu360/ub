                  ...
                  <tbody>
                   <?php foreach($courses as $course): 
                    ...
                    <tr>
                      ...
                      <td><?= $tution; ?></td>
                      <td><?= $app; ?></td>
                        <td> <?= Html::a(Yii::t('app', 'Apply Now'),['/recruiter/programs-colleges/apply-now'], ['class' => 'common-dashboard-circle-btn', 'data-course-id' =>$course->id, 'data-college-id' => $model->id,'data-bs-toggle'=> 'modal', 'data-bs-target' => '#studentModal']) ?></td>
      ...
      <div class="modal-body">        
        <?php
          ...
          echo Typeahead::widget([
            'name' => 'search_student', 
            'options' => ['placeholder' => 'Serach student name, email or ID ...'],
