...
?>
<h4 class="common-sub-heading">Student Profile: <?=$model->id?></h4>
            ...
            <div class="row">
                ...
                <div class="mb-3">       
                    <?=$form->field($model, 'study_permit')->widget(Select2::classname(), [
                        ...
                        'maintainOrder' => true,
                        'options' => ['multiple' => true, 'value'=> explode(',', $model->study_permit)],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'autocomplete' => false,
                        ],
...
$script = <<< JS
    $(function(){
        ...
        $('.field-forstudents-gmat_total_score').on('blur', '#forstudents-gmat_total_score', function(){
            var value = $(this).val();
            if(value < 200){
                $(this).val(200);
            }
