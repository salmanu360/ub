    ...
    <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow dashboard-top-menu">
      <a class="offset-md-2 col-md-2 mr-0 dashboard-bar" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
        ...
        <ul class="navbar-nav top-dashboard-menu px-3 col-md-8 text-end align-items-center">
            <li class="nav-item">
                <a class="nav-link add-student-btn" href="<?=Url::to(['/recruiter/student/create'])?>">Register new Student</a>
            </li>
            ...
            <?php $notificationCount=\common\models\Notification::find()->where(['status'=>0,'receiver_id'=>Yii::$app->user->identity->id])->count();
             $latestNotifiation=\common\models\Notification::find()
                            //->limit(10)
                            ->where(['status'=>0,'receiver_id'=>Yii::$app->user->identity->id])
            ...
            <li class="nav-item dropstart">
              ...
              <i class="fa fa-bell" style="border:none;"></i><?php echo $notificationCount;?>
                ...
                <ul class="dropdown-menu" style="overflow: scroll;height: 500px;    width: 300px;">
                   ...
                   <li>
                    ...
                    <?php $show= $notificationvalue->module.' ('.$notificationvalue->name.') by '.$notificationvalue->created_by;
                     ...
                     <?php }else if($notificationvalue->module =='chat'){?>
                        <a href="<?php echo Url::to(['/recruiter/chat/create?id='.$notificationvalue->created_by_id])?>"> <strong><?php $show= $notificationvalue->module.' ('.$notificationvalue->name.') by '.$notificationvalue->created_by;
                                    echo wordwrap($show,40,"<br>\n");?></a></strong>

                    <?php }else if($notificationvalue->module =='assign student'){?>
                        <a class="dropdown-item" href="<?= Url::to(['assign-student-recruiter/index']) ?>">
                        <?php $show=$notificationvalue->module.' (created by) '.$notificationvalue->created_by;
                                    echo wordwrap($show,28,"<br>\n");?>
                    </a>
                     <?php }else if($notificationvalue->module =='Comment Recruiter by RM'){?>
                        <a class="dropdown-item" href="<?= Url::to(['rm-recruiter-comment/index']) ?>">
                        <?php $show=$notificationvalue->module.' (created by) '.$notificationvalue->created_by;
                                    echo wordwrap($show,28,"<br>\n");?>
                    </a>
                     <?php }else if($notificationvalue->module =='student lead changed'){?>
                        <a class="dropdown-item" href="<?= Url::to(['student/index']) ?>">
                        <?php $show=$notificationvalue->module.' (created by) '.$notificationvalue->created_by;
                                    echo wordwrap($show,28,"<br>\n");?>
                    </a>
                     <?php }?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 bg-light d-none d-md-block sidebar dashboard-main-menu">
                <div class="left-sidebar">
                    ...
                    <ul class="nav flex-column sidebar-nav desktop-view">
                        ...
                        <li class="nav-item">
                            <a target="_blank" class="nav-link <?php if(Yii::$app->controller->id == 'mou'){ echo "active"; } ?>" href="<?=Url::to(['default/mou'])?>">
                                <i class="fas fa-user-graduate"></i> MOU
                            </a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link <?php if(Yii::$app->controller->id == 'assign-student-recruiter'){ echo "active"; } ?>" href="<?=Url::to(['assign-student-recruiter/index'])?>">
                                <i class="fas fa-user-graduate"></i> Assign Students
                            </a>
                        </li>
                        
                        <!--<li class="nav-item">
                            <a class="nav-link <?php if(Yii::$app->controller->id == 'rm-recruiter-comment/index'){ echo "active"; } ?>" href="<?=Url::to(['rm-recruiter-comment/index'])?>">
                                <i class="fas fa-user-graduate"></i> RM Comments
                            </a>
                        </li>-->
                    ...
                    <li class="nav-item dropstart">
                      <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" href="#">
                        <i class="fas fa-search"></i>Programs & Colleges  <i class="fas fa-caret-right" style="border: none;"></i>
                      </a>
                        <ul class="dropdown-menu">
            ...
            <!-- more services -->
                    <li class="nav-item dropstart">
                      <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" href="#">
                        <i class="fas fa-bookmark"></i>More services <i class="fas fa-caret-right" style="border: none;"></i>
                      </a>
                        <ul class="dropdown-menu">
                            <?php $moreservices=\common\models\MoreServices::find()->all();
                            foreach($moreservices as $valueservice){?>
                            <li class="nav-item">
                                <a target="_blank" style="text-align: center;"class="nav-link" href="<?php echo $valueservice->link;?>">
                                    <?php echo $valueservice->name;?>
                                </a>
                            </li> 
                        <?php }?>
            ...
            <!-- more services end -->
                       ...
                       <!--  <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?=Url::to(['/recruiter/chat/create','id' =>1])?>">
                ...
                <div class="left-sidebar-footer">
                  <ul class="nav inline-list side-icon">
                    ...
                    <li class="nav-item">
                      <a href="tel:+91-9355500042"><i class="fa fa-phone" aria-hidden="true"></i>+91-9355500042</a>
                    </li>
...
<div class="row">
            ...
            <div class="col-md-2" style="margin-top: -58px;">
            <a href="<?=Url::to(['/recruiter/chat/create','id' =>1])?>">
                <img style="padding: 55px;" src="<?php echo Yii::$app->request->baseUrl;?>/backend/web/chat.png"></a>
            </div>
        </div>
