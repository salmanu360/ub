            ...
            <div class="dashboard-card top-red-border mb-5">
                <div class="giiant-crud student-college-applied-index">
                    ...
                    <h2 class="common-dashboard-heading">
                        <?= Yii::t('models.plural', 'Student Applications') ?>
                        <small>
                            <?= Yii::t('cruds', 'Lists') ?>
                        </small>
                    </h2>
                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                [
                                    ...
                                    'template' => $actionColumnTemplateString . '{delete} {view} {pay_app_fee} {pay_visa_fee}',
                                    'buttons' => [
                                        ...
                                        'pay_app_fee' => function ($url, $model, $key) {
                                            ...
                                            $options = [
                                                ...
                                                'data-student_name' => $student->first_name . ' ' . $student->middle_name . ' ' . $student->last_name,
                                                'data-student_email' => $student->email_id,
                                                'data-student_phone' => $student->phone_no,
                                            ];
                                            if($model->application_fee_status !== StudentCollegeApplied::STATUS_APP_FEE_PAID && !empty($model->application_fee) ) {
                                        ...
                                        'pay_visa_fee' => function ($url, $model, $key) {
                                            ...
                                            if($model->visa_fee_status !== StudentCollegeApplied::STATUS_VISA_FEE_PAID && !empty($model->visa_fee)) {
    ...
    var options = {
       ...
       // "image": "https://universitybureau.com/images/logo.png",
        "handler": function (response){
            $.ajax({
                url: 'recruiter/student-application/payment-success',
                type: 'post',
                dataType: 'json',
                data: {
                ...
                success: function (result) {
                    window.location.href = 'recruiter/student-application/index';
                }
            });
        },
        "prefill": {
