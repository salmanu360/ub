    ...
    <div class="accordion" id="accordionExample">
        ...
        <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
           ...
           <!-- <?php if(!empty($model->ten_certificate)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download 10th Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span> -->
            <?= $form->field($model, 'ten_certificate[]')->fileInput(['multiple' => true, 'class' => 'form-control'])->label('10th Certificate'); ?>


                <!-- <?php if(!empty($model->twelve_certificate)){
                    $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->twelve_certificate]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download 12th Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?> -->
               
                <?= $form->field($model, 'twelve_certificate[]')->fileInput(['multiple' => true, 'class' => 'form-control'])->label('12th Certificate'); ?>
                ...
                <?php if(!empty($model->ielts)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download IELTS/PTE/TOEFL <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br> -->
                ...
                <?php if(!empty($model->lor)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download LOR <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br> -->
                ...
                <?php if(!empty($model->moi)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download MOI <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br> -->
                ...
                <?php if(!empty($model->sop)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download SOP <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br> -->
                ...
                <?php if(!empty($model->master_certificate)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Masters Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br> -->
                ...
                <?php if(!empty($model->work_experiance)){?>
                    <table class="table table-striped table-hover table-bordered">
                        <thead>
                            <?php if(!empty($model->work_experiance)){?>
                            <tr>
                                <th style="width: 473px;" colspan="4">Work Experiance</th>
                                <td><?php
                ...
                <?php if(!empty($model->other_certificate)){?>
                    <table class="table table-striped table-hover table-bordered">
                        <thead>
                            <?php if(!empty($model->other_certificate)){?>
                            <tr>
                                <th style="width: 473px;" colspan="4">Other Certificate </th>
                                <td><?php
                                $other_certificate_explode_work= explode(',',$model->other_certificate);
                                foreach($other_certificate_explode_work as $key =>$other1){
                                    $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$other1]);?>
                                  <a href="<?php echo $url?>"  class="" title="Download document">Download Attachment  | <i class="fa fa-download fa-fw"></i></a>
                                <?php }?></td>
                            </tr>
