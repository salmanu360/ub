...
<?php $form = ActiveForm::begin([
        'id' => 'Student-profile',
        'options' => ['class' => 'dashboard-pills', 'enctype' => 'multipart/form-data'],
        'layout' => 'default',
    ...
    <div class="accordion" id="accordionExample">
            ...
            <div class="row">
                ...
                <div class="col-md-4 grade-avg <?php if(!$model->grading_scheme){ echo "hide"; } ?>">
                    <div class="mb-3">
                        ...
                        <?= $form->field($model, 'grade_average')->textInput(['type' => 'number', 'min' => 0,'placeholder' => 'Grade Average']) ?>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
        ...
        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                <?php 
                echo $form->field($collegeModel, 'institution_country')->widget(Select2::classname(), [
                    'data' => \common\models\Country::optsCountry(),
        ...
        <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
           ...
           <?php if(!empty($model->ten_certificate)){
                    ...
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Ten Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span>
            <?= $form->field($model, 'ten_certificate')->fileInput(['maxlength' => true, 'class' => 'form-control']); ?>


                <?php if(!empty($model->twelve_certificate)){
                    $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->twelve_certificate]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download twelve Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
               
                <?= $form->field($model, 'twelve_certificate')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>

                <span class="downloadMargin">
                <?php if(!empty($model->passport)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->passport]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download passport <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br>
                <?= $form->field($model, 'passport')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>



                <span class="downloadMargin">
                <?php if(!empty($model->ielts)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->ielts]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download ielts Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br>
                <?= $form->field($model, 'ielts')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>



                <span class="downloadMargin">
                <?php if(!empty($model->graduation_certificate)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->graduation_certificate]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Graduation Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br>
                <?= $form->field($model, 'graduation_certificate')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>



                <span class="downloadMargin">
                <?php if(!empty($model->lor)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->lor]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download LOR Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br>
                <?= $form->field($model, 'lor')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>



                <span class="downloadMargin">
                <?php if(!empty($model->moi)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->moi]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download MOI Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br>
                <?= $form->field($model, 'moi')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>

                <span class="downloadMargin">
                <?php if(!empty($model->sop)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->sop]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download SOP Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br>
                <?= $form->field($model, 'sop')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>


                <span class="downloadMargin">
                <?php if(!empty($model->diploma_certificate)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->diploma_certificate]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Diploma Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br>
                <?= $form->field($model, 'diploma_certificate')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>



                <span class="downloadMargin">
                <?php if(!empty($model->master_certificate)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->master_certificate]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Master Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span><br><br>
                <?= $form->field($model, 'master_certificate')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>


                <span class="downloadMargin">
                <?php if(!empty($model->updated_cv)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->updated_cv]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Updated CV<i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span>
                <?= $form->field($model, 'updated_cv')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>


                <span class="downloadMargin">
                <?php if(!empty($model->work_experiance)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->work_experiance]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Work Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span>
                <?= $form->field($model, 'work_experiance')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>


                <span class="downloadMargin">
                <?php if(!empty($model->other_certificate)){
                     $url=Url::to(['student/downloaddocument','id'=>$model->id,'c'=>$model->other_certificate]);
                    echo  '<a href="'.$url.'"  class="" title="Download document">Download Other Certificate <i class="fa fa-download fa-fw"></i></a>';
                   }?>
                </span>
                <?= $form->field($model, 'other_certificate')->fileInput(['maxlength' => true, 'class' => 'form-control']) ?>
            ...
            ?>
            <?php /*echo $form->field($model, 'upload_document[]')->widget(FileInput::classname(), [
                'options' => ['multiple' => true],
                'pluginOptions' => [
                    'showPreview' => true,
                    'showCaption' => true,
