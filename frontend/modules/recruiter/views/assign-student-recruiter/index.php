    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => "{telecmi}",
                'buttons' => [
                    'telecmi' => function ($url, $model) {
                        $url1=Url::to('recruiter/assign-student-recruiter/telecmi?id='.$model->student_id);
                        return Html::a('<i class="fa fa-phone"></i>', $url1, ['class'=>'btn btn-danger btn-xs','title'=>"Call"]);
                },
                ],
            ],
        ],
