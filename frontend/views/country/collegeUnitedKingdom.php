...
<section class="banner-menu mob-inner-height lp-banner-height" style="background-color: #000;padding-top: 140px;">
            <img src="images/uk/uk-banner.PNG" alt="banner-img" class="desktop-view-only w-100">
    </section>
            ...
            <div class="table-responsive">
                <table class="table promoting-table">
                    ...
                    <tbody>
                        <tr class="">
                            <td scope="row">1.</td>
                            <td><img src="images/uk/abertay.PNG" alt=""></td>
                            <td>Scotland</td>
                            <td>Jan,Sep</td>
                            <td>
                                <ul>
                        ...
                        <tr class="">
                            <td scope="row">2.</td>
                            <td><img src="images/uk/solent.PNG" alt=""></td>
                            <td>England</td>
                            <td>Jan,june,Sep</td>
                            <td>
                                <ul>
                        ...
                        <tr class="">
                            <td scope="row">3.</td>
                            <td><img src="images/uk/west-england.PNG" alt=""></td>
                            <td>England</td>
                            <td>Jan,Sep</td>
                            <td>
                                <ul>
