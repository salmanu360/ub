...
use yii\bootstrap\ActiveForm;
    $this->title = "Study in Canada - Universities, Colleges, Courses, Eligibility, Admission  Process, Cost ";
    $this->registerMetaTag(['name' => 'description', 'content' =>  "Wants to Study in Canada? Get advice from Canada Study Abroad Consultant who will provides complete details on Top Canada Colleges, Universities, 2023 Intakes, Study Programs and Courses, Visa Process and many more"]);
...
<!-------------------------------------------------------- landing page ----------------------------------------------------------------------------------------- -->
                ...
                'method' => 'post',
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12">
                          ...
                          <input type="hidden" value="Canada" name="GetInTouchCountry[study_country]">
    ...
    <div class="bg-video-wrap-lp">
      ...
      <img src="images/canada-landing-page-banner-mob.jpg" alt="banner-img" class="mob-view-only w-100">
            ...
            <div class="col-md-12 lpage-top-universities-slider">
              <div class="row">
                <div class="3-col-items" style="display: flex; flex-wrap: wrap;">
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-1.jpg" alt="best universities in canada"><h4>University of Winnipeg</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-2.jpg" alt="top universities in canada"><h4>Brock University</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-3.jpg" alt="courses to study in canada"><h4>University of Saskatchewan</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-4.jpg" alt="best colleges in canada"><h4>Memorial University of Newfoundland and Labrador</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-5.jpg" alt="top colleges in canada"><h4>Cambrian University</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-6.jpg" alt="top 10 universities in canada"><h4>Okanagan College</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-7.jpg"><h4>Concordia University</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-8.jpg"><h4>Seneca College</h4></div>
                  <div class="col-md-4" style="padding-bottom: 25px;"><img class="w-100 p-2" src="images/top-university-img-9.jpg"><h4>Carleton University</h4></div>
                </div>
              </div>
            </div>
          </div>
