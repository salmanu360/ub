...
<section class="banner-menu mob-inner-height">
    <div class="bg-video-wrap-affilate">
      <img src="images/affilate-page-banner.jpg" alt="banner-img" class="desktop-view-only w-100">
      <img src="images/affilate-page-banner.jpg" alt="banner-img" class="mob-view-only w-100">
      ...
      <div class="row">
        ...
        <div class="col-md-12 text-center pt-3">
          <p class="apage-earning-text">
            Spread the word about the University bureau to your readers, viewers, followers, friends, or family and get a 50% profit share plus incentives for each qualified lead that gets the visa.
            <br>
            <br>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 text-center">
          <button class="apage-journey-joinus-btn">Join Us</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="affilate-page-our-guidance">
    <div class="container">
      ...
      <div class="col-md-12 text-center">
        <button class="apage-our-guidance-joinus-btn">Join Us Today</button>
      </div>
    </div>
  </section>
        ...
        <div class="col-md-12 apage-testimonial-container">
          <div class="row">
            <div class="col-md-4 apage-testimonial-inner">
              <img src="images/testimonial-box-img.png">
          ...
          <div class="row">
            ...
            <div class="col-md-6 apage-revenue-share-inner">
              ...
              <p>
                ...
                <br>
                <br>
                A profit sharing system allows us to share 50% profit plus incentives with you as a partner..
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="affilate-page-refer-more">
    <div class="container">
      ...
      <div class="col-md-12 apage-refer-more-btn-box">
        <a class="apage-refer-more-btn">Join Affiliate Program</a>
        <img src="images/join-arrow-gif.gif">
      </div>
    </div>
  </section>
