          ...
          <div class="col-md-12">
            <div class="login-form thankyou-page">
              <div class="text-center">
                <h3>Thank you for collaborating with the University Bureau. Your request has been successfully registered with the University Bureau.
</h3>
                <br>
                <p class="text-white">Your credentials will be shared soon on your e-mail id.</p>
                <br>
                <br>
