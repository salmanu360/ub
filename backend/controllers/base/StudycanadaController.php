...
use common\models\StudycanadaSearch;
...
/**
* CollegeController implements the CRUD actions for CollegeController model.
*/
class StudycanadaController extends Controller
{
...
*/
    public function actionIndex()
    {
        ...
        $searchModel  = new StudycanadaSearch;
...
*/
    protected function findModel($id)
        {
        if (($model = StudyApply::findOne($id)) !== null) {
        return $model;
        } else {
