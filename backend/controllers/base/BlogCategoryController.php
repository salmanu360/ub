...
echo("<script>location.href = 'https://universitybureau.com/backend/web/blog-category/view?id=$model->id';</script>");
...
echo("<script>location.href = 'https://universitybureau.com/backend/web/blog-category/index';</script>");
}
