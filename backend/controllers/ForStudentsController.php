...
use common\models\ForStudentsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ForStudentsController implements the CRUD actions for ForStudents model.
 */
class ForStudentsController extends Controller
{
    ...
    {
        if (($model = ForStudents::findOne(['id' => $id])) !== null) {
            return $model;
        }
