...
if (isset($actionColumnTemplates)) {
    ...
    $actionColumnTemplateString = "{add_fee}";
}
$actionColumnTemplateString = '<div class="action-buttons">'.$actionColumnTemplateString.'</div>';

$student = \common\models\User::findOne(['id' => $model->user_id]);
?>
<div class="giiant-crud for-student-applications-index">
    ...
    <h1>
        <?= Yii::t('app', 'Student Applications') ?>
        <small>
            <?= Yii::t('app', 'List') ?>
        </small>
    </h1>
    ...
    <ul class="stats-overview mb-4" style="margin-bottom: 30px;">
            ...
            <li>
                ...
                <span class="value text-success"> <?=$model->first_name . ' ' . $model->last_name?> </span>
            </li>
                <li class="hidden-phone">
                <span class="name"> Recruiter Email </span>
                <span class="value text-success"> <?=$student->email?> </span>
            </li>
        </ul>
                ...
                'buttons' => [
                    'add_fee' => function ($url, $model, $key) {
                        $options = [
                            ...
                            'data-toggle' => 'modal',
                            'class' => ' add-fee-btn btn btn-primary btn-xs',
